...
- Gate CI on pm health for tracker integrity (does not cover discarded peer edits, see pm-cli 922) ([pm-beads-bzpz](https://github.com/unbraind/pm-beads/blob/main/.agents/pm/chores/pm-beads-bzpz.toon))
